...
class ModelSelection(BaseModel):
    ...
    maximum_equalized_odds_gap: float | None = Field(default=None, ge=0, le=1)
    maximum_demographic_parity_gap: float | None = Field(default=None, ge=0, le=1)
    minimum_disparate_impact_ratio: float | None = Field(default=None, ge=0, le=1)
...
class GroupingRule(BaseModel):
    ...
    q: int | None = Field(default=None, ge=2)
